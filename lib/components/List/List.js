...
var ItemRightContent = _styledComponents2.default.div.attrs({
	...
	componentId: 's12rbeej-4'
})(['text-align:right;min-width:90px;']);

var ItemRightTitle = _styledComponents2.default.div.attrs({
	className: 'ItemRightTitle'
}).withConfig({
	displayName: 'List__ItemRightTitle',
	componentId: 's12rbeej-5'
})(['flex-grow:1;']);
