...
var SwitchComp = _styledComponents2.default.div.attrs({
	...
	componentId: 's1q8qz4h-1'
})(['background-color:', ';border-radius:0.75em;display:inline-block;height:1.5em;position:relative;transition:background-color 0.3s ease-out;min-width:3em;width:3em;max-width:3em;', ';'], switchContainerColorOff, function (props) {
