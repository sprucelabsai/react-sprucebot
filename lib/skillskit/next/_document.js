		...
		value: function () {
			var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref2) {
				var renderPage = _ref2.renderPage,
				    query = _ref2.query,
				    store = _ref2.store;
				var sheet, auth, config, whitelabel, page, styleTags;
					...
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								...
								auth = store && store.getState().auth;
								config = store && store.getState().config;
								whitelabel = false;
								...
								return _context.abrupt('return', _extends({}, page, { styleTags: styleTags, whitelabel: whitelabel, auth: auth, config: config }));
