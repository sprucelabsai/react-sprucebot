	...
	return function (_Component) {
		...
		_createClass(_class, [{
			...
			value: function render() {
				if (this.props.devMode) {
					return _react2.default.createElement(
						...
						_react2.default.createElement(ConnectedWrapped, _extends({}, this.props, { skill: _index2.default }))
					);
				}
				return _react2.default.createElement(ConnectedWrapped, _extends({}, this.props, { skill: _index2.default }));
			}
		}], [{
			key: 'getInitialProps',
			...
			value: async function getInitialProps(_ref) {
				...
				if (!props.public && (!props.auth || !props.auth.role || props.auth.error)) {
